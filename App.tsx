...
import { auth, db, googleProvider, firebase } from './services/firebase'; // Pastikan path ini benar
import { LineChart, Line, XAxis, YAxis, Tooltip, Legend, ResponsiveContainer } from 'recharts';
import type { User, Transaction, Goal, Wallet, Debt, NavItem, UserProfile, Theme, TransactionType, WalletType, DebtType } from './types'; // Pastikan path ini benar
import {
...
import { TRANSACTION_CATEGORIES, CURRENCIES, AVATAR_OPTIONS } from './constants'; // Pastikan path ini benar
        ...
        <Modal isOpen={isOpen} onClose={onClose} title={`Edit Wallet`}>
            <form onSubmit={handleUpdate} className="space-y-4">
                ...
                <div className="pt-2 space-y-2">
                    ...
                    {walletHasTransactions && <p className="text-xs text-center text-light-text-secondary dark:text-dark-text-secondary mt-2">Cannot delete wallet with transactions.</p>}
                </div>
            </form>
        </Modal>
    );
